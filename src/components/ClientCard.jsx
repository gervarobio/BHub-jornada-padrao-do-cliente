      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 3, alignItems: "center" }}>
            {step.screenshot && (
              <span style={{
                fontSize: 7, padding: "2px 4px", borderRadius: 4,
            ...
            <span style={{
              fontSize: 8, padding: "2px 5px", borderRadius: 8,
        ...
        <div style={{ fontSize: 14, fontWeight: 700, lineHeight: 1.3, marginBottom: (isExpanded || fb) ? 6 : 0 }}>
          {step.title}
        </div>
        ...
        {!isExpanded && fb && (
          <div style={{
            fontSize: 9, color: fb.color, fontWeight: 600,
          ...
          <div style={{ animation: "fadeIn 0.3s ease" }}>
            {fb && (
              <div style={{
                ...
                <span style={{ fontSize: 15 }}>{fb.icon}</span>
                <div>
            ...
            {screenshotSrc && (
              ...
              >
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: 10, color: "#94A3B8" }}>{step.screenshotCaption}</span>
                  <span style={{ fontSize: 9, color: "#4A6A8A", fontFamily: "'Space Mono', monospace" }}>
                    🔍 Ampliar
                  </span>
                </div>
              </div>
